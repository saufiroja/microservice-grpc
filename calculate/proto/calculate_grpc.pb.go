...
func (c *calculateServiceClient) Max(ctx context.Context, opts ...grpc.CallOption) (CalculateService_MaxClient, error) {
	stream, err := c.cc.NewStream(ctx, &CalculateService_ServiceDesc.Streams[2], "/calculate.CalculateService/Max", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *calculateServiceMaxClient) Recv() (*AvgResponse, error) {
	m := new(AvgResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *calculateServiceClient) Sqrt(ctx context.Context, in *SqrtRequest, opts ...grpc.CallOption) (*SqrtResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/calculate.CalculateService/Sqrt", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (x *calculateServiceMaxServer) Send(m *AvgResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
func _CalculateService_Sqrt_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/calculate.CalculateService/Sqrt",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
